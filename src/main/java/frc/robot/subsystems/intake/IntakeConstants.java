...
public  class IntakeConstants {
  ...
  public static final class IntakeRollerConstants {
    ...
    public static LoggedNetworkNumber p = new LoggedNetworkNumber("/Tuning/Intake/Roller/PID/P", 0);
    public static final LoggedNetworkNumber i = new LoggedNetworkNumber("/Tuning/Intake/Roller/PID/I", 0);
    public static final LoggedNetworkNumber d = new LoggedNetworkNumber("/Tuning/Intake/Roller/PID/D", 0.0);
    public static final LoggedNetworkNumber kS = new LoggedNetworkNumber("/Tuning/Intake/Roller/PID/kS", 0);
    public static final LoggedNetworkNumber kV = new LoggedNetworkNumber("/Tuning/Intake/Roller/PID/kV", 0);
  ...
  public static final class IntakePivotConstants {
    ...
    public static final LoggedNetworkNumber p = new LoggedNetworkNumber("/Tuning/Intake/Pivot/PID/P", 15);
    public static final LoggedNetworkNumber i = new LoggedNetworkNumber("/Tuning/Intake/Pivot/PID/I", 0);
    public static final LoggedNetworkNumber d = new LoggedNetworkNumber("/Tuning/Intake/Pivot/PID/D", 0.5);
    public static final LoggedNetworkNumber s = new LoggedNetworkNumber("/Tuning/Intake/Pivot/PID/kS", 0.375);
    public static final LoggedNetworkNumber v = new LoggedNetworkNumber("/Tuning/Intake/Pivot/PID/kV", 6);

    public static final LoggedNetworkNumber g = new LoggedNetworkNumber("/Tuning/Intake/Pivot/PID/kG", 0.0);
    public static final double maxIAccum = 0.2;
