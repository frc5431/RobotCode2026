...
public abstract class DrivebaseSubsystem extends SubsystemBase {
  ...
  /**
   * A basic implementation of arcade drive using a Arbitrary Feed Forward like formula go to
   * https://docs.ctre-phoenix.com/en/latest/ch16_ClosedLoop.html#arbitrary-feed-forward for more
   * information
   *
  ...
  public final void driveArcade(double power, double turn) {
    ...
    if (Math.abs(power) == -0.0) power = 0.0;
