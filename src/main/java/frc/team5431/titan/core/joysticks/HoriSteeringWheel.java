...
public class HoriSteeringWheel extends GenericHID {
  ...
  /**
   * Constructs an event instance around the axis value of L2. The returned trigger will be true
   ...
   * @param loop the event loop instance to attach the event to.
   * @return an event instance that is true when the L2's axis exceeds the provided threshold,
  ...
  /**
   * Constructs an event instance around the axis value of the L2. The returned trigger will be true
  ...
  /**
   * Constructs an event instance around the axis value of R2. The returned trigger will be true
   * when the axis value is greater than {@code threshold}.
   *
   * @param threshold the minimum axis value for the returned {@link BooleanEvent} to be true. This
   *     value should be in the range [0, 1] where 0 is the unpressed state of the axis.
   * @param loop the event loop instance to attach the event to.
   * @return an event instance that is true when the R2's axis exceeds the provided threshold,
   *     attached to the given event loop
   */
  ...
  /**
   * Constructs an event instance around the axis value of the R2. The returned trigger will be true
   * when the axis value is greater than 0.5.
   *
   * @param loop the event loop instance to attach the event to.
   * @return an event instance that is true when the R2's axis exceeds the provided threshold,
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return an event instance that is true when the paddle's axis indicates left, attached to the
   *     given event loop
   */
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return an event instance that is true when the paddle's axis indicates right, attached to the
   *     given event loop
   */
