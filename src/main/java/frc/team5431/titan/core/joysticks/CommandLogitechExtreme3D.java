...
/** Custom Logitech Extreme class that has enums for controller bindings deadzone management */
public class CommandLogitechExtreme3D extends CommandJoystick {
  ...
  /**
   * Get a Trigger to bind commands to. To use this with an EventLoop other than the default command
   * loop, use button(ButtonZone, loop)
   *
