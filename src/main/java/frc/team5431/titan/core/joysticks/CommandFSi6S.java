...
public class CommandFSi6S extends CommandJoystick {
      ...
      case B:
        {
          ...
          if (top) return SwitchPosition.UP;
          else if (bottom) return SwitchPosition.DOWN;
          else return SwitchPosition.NEUTRAL;
        }
      case C:
        {
  ...
  /**
   * Creates a Trigger that evaluates to true when the switch is in the specified position
   *
