...
public class CommandSkyFlyController extends CommandGenericHID {
  ...
  /**
   * This was made because for some reason, this controller has a range of 0.83 for some reason.
   *
  ...
  /**
   * The trigger is positive when the right lever is flipped backwards. This lever is to the left of
   * the right switch
   *
   * @return A trigger that maps to the switch on the left of the controller
   */
  ...
  /**
   * The trigger is positive when the right lever is flipped forwards. This lever is to the left of
   * the right switch
   *
   * @return A trigger that maps to the switch on the left of the controller
   */
  ...
  /**
   * The trigger is positive when the left lever is flipped backwards. This lever is to the right of
   * the left switch
   *
   * @return A trigger that maps to the switch on the left of the controller
   */
  ...
  /**
   * The trigger is positive when the left lever is flipped forwards. This lever is to the right of
   * the left switch
   *
   * @return A trigger that maps to the switch on the left of the controller
   */
